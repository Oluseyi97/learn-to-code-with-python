...
class PlayerTest(unittest.TestCase):
    def test_stores_name_and_hand(self):
        hand = Hand()
        player = Player(name  = "Oluseyi", hand = hand)
        self.assertEqual(player.name, "Oluseyi")
    ...
    def test_figures_out_own_best_hand(self):
        ...
        player = Player(name  = "Oluseyi", hand = mock_hand)
    ...
    def test_passes_new_cards_to_hand(self):
        mock_hand = MagicMock()
        player = Player(name = "Esther", hand = mock_hand)
