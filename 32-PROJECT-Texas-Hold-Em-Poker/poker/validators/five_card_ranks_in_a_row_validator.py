class FiveCardRanksInARowValidator():
    @property
    def _collections_of_five_consecutive_cards_in_a_row(self):
        index = 0
        final_index = len(self.cards) - 1
        collections_of_five_consecutive_cards_in_a_row = []
        ...
        while index + 4 <= final_index:
            ...
            if self._every_element_increasing_by_1(next_five_rank_indices):
                collections_of_five_consecutive_cards_in_a_row.append(next_five_cards)

            index += 1
        
        return collections_of_five_consecutive_cards_in_a_row
